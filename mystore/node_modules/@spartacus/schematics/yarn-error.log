Arguments:
  C:\Program Files\nodejs\node.exe C:\Program Files (x86)\Yarn\bin\yarn.js clean

PATH:
  C:\Program Files\Git\mingw64\bin;C:\Program Files\Git\usr\bin;C:\Users\Patryk\bin;C:\Users\Patryk\Desktop\spartacus\node_modules\.bin;C:\Python38\Scripts;C:\Python38;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0;C:\Windows\System32\OpenSSH;C:\Program Files\Git\cmd;C:\Program Files (x86)\Yarn\bin;C:\Program Files\7-Zip;C:\Program Files\nodejs;C:\ProgramData\chocolatey\bin;C:\Users\Patryk\AppData\Local\Microsoft\WindowsApps;C:\Users\Patryk\AppData\Local\Programs\Microsoft VS Code\bin;C:\Users\Patryk\AppData\Local\Yarn\bin;C:\Program Files\7-Zip;C:\Users\Patryk\AppData\Roaming\npm
...
Trace:
  SyntaxError: C:\Users\Patryk\Desktop\spartacus\projects\schematics\package.json: Unexpected token f in JSON at position 753
...
npm manifest:
  {
    ...
    "scripts": {
      "clean": "rm -v src/*/*.js src/*/*.js.map src/*/*.d.ts",
    ...
    find src -name "*\.js" -and -name "*\.js\.map" -and -name "*\.d\.ts"  -exec ls {} \;
...
Lockfile:
  ...
  "@angular/localize@^9.1.0":
    version "9.1.0"
    resolved "https://registry.yarnpkg.com/@angular/localize/-/localize-9.1.0.tgz#99ed643fd1b60942e0e890236c75381a026040b6"
    integrity sha512-llM46gLyxW6jD0VQcLSGLMB0nZ0FIWAp1W2BMWbUspmcSCEcLmdhSWKPpZLFt/vGtpvGYSY/LDeScaHSRmAe+g==
    dependencies:
      "@babel/core" "7.8.3"
      glob "7.1.2"
      yargs "15.3.0"
  ...
  "@angular/pwa@^0.901.0":
    version "0.901.0"
    resolved "https://registry.yarnpkg.com/@angular/pwa/-/pwa-0.901.0.tgz#2b4c1b3123fee0afc6923e3f97590eb4801650b2"
    integrity sha512-J2YnH0Gy2Gbkekzjuoa1jW3W7YhAQ/rj0wqSCdqjuFaMFM6vpYuMnbzE+wBNKGC+vce+xW5v/5Q6qRLLzAZymQ==
    dependencies:
      "@angular-devkit/core" "9.1.0"
      "@angular-devkit/schematics" "9.1.0"
      "@schematics/angular" "9.1.0"
  ...
  "@schematics/angular@9.1.0", "@schematics/angular@^9.1.0":
    version "9.1.0"
  ...
  chownr@^1.1.2, chownr@^1.1.3, chownr@^1.1.4:
    version "1.1.4"
