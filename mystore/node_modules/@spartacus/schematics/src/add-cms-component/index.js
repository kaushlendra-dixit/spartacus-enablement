...
function updateComponent(options) {
    return (tree, _context) => {
        ...
        const componentFileName = `${core_1.strings.dasherize(options.name)}.${core_1.strings.dasherize(options.type)}.ts`;
        const { workspace } = workspace_utils_1.getWorkspace(tree);
        ...
        const injectionChange = file_utils_1.injectService(constructorNode, componentPath, cmsComponentData, 'private', constants_1.CMS_COMPONENT_DATA_PROPERTY_NAME);
