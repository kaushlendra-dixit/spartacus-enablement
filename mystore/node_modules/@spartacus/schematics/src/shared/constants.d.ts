...
export declare const DEFAULT_ANGULAR_VERSION = "^9.1.0";
export declare const ANGULAR_UNIVERSAL_EXPRESS_VERSION = "^9.1.1";
export declare const ANGULAR_UNIVERSAL_BUILDERS = "^9.1.0";
export declare const DEFAULT_NGRX_VERSION = "~9.1.0";
...
export declare const ANGULAR_LOCALIZE = "@angular/localize";
...
export declare const LAUNCH_DIALOG_SERVICE = "LaunchComponentService";
...
export declare const CSS_DOCS_URL = "https://sap.github.io/spartacus-docs/updating-to-version-2/css";
/***** Misc end *****/
