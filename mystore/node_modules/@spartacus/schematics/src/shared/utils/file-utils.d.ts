...
export declare function getIndexHtmlPath(project: experimental.workspace.WorkspaceProject): string;
...
export declare function injectService(constructorNode: ts.Node | undefined, path: string, serviceName: string, modifier: 'private' | 'protected' | 'public' | 'no-modifier', propertyName?: string): InsertChange;
